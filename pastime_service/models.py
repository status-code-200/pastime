...
class Event(models.Model):
    ...
    event_number_of_persons = models.IntegerField(validators=[MinValueValidator(2), MaxValueValidator(100)], verbose_name='количество человек')
    event_persons = models.ManyToManyField(CustomizedUser, verbose_name='уже идут', blank=True)
